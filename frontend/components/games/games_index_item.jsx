...
const GameIndexItem = ({game}) => (
    <div className="index-item-information">
        <div className="game-photo">
            <p className="game-image-tag"><Link to="/directory/game/" style={{color: "rgb(100, 65, 165)", textDecoration: 'none' }}><img className="game-photograph" src={game.photoUrl} alt="Cannot Display" height="221" width="166"/></Link></p>
